...
CREATE TABLE `__new_organizations` (
	...
	CONSTRAINT "organizations_name_check" CHECK(length("__new_organizations"."name") between 3 and 120 and "__new_organizations"."name" = trim("__new_organizations"."name")),
